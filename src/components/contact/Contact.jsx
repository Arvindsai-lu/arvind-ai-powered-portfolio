  ...
  const sendEmail = async (e) => {
    ...
    try {
      const result = await emailjs.sendForm(
        'service_7hkta68',           // Your EmailJS service ID
        'template_wfdzpf1',          // Your EmailJS template ID
        form.current,
        'P1IKNznf6iIZqspzG'          // Your EmailJS public key
      );
      ...
      <div className="container contact__container">
        ...
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a 
              href="mailto:arvindsaidooda@gmail.com" 
              target="_blank" 
              rel="noopener noreferrer"
              aria-label="Send email to Arvind"
            >
              Send a message
            </a>
          </article>
          ...
          <article className="contact__option">
            ...
            <a 
              href="https://m.me/arvind-sai-dooda.trying" 
              target="_blank" 
              rel="noopener noreferrer"
          ...
          <article className="contact__option">
            ...
            <h5>Arvind Sai Dooda</h5>
            <a 
              href="https://www.linkedin.com/in/arvind-sai-dooda/" 
              target="_blank" 
              rel="noopener noreferrer"
        ...
        <form ref={form} onSubmit={sendEmail} className="contact__form">
          ...
          <div className="form__group">
            <textarea
              name="message"
              rows="7"
              placeholder="Hi Arvind, I'd like to discuss..."
